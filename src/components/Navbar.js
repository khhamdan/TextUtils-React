  ...
  return (
    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div className={`form-check form-switch text-${props.mode2 === 'light'?'#198754':'light'}`}>
      <input className="form-check-input" onClick={props.greenToggleMode} type="checkbox" role="switch" id="flexSwitchCheckDefault"/>
      <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable Dark Green Mode</label>
    </div>
...
// Navbar.defaultProps = {title: "Hamdan", 
//                         aboutText: "About",}
